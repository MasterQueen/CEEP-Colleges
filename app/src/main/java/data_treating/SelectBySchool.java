...
public class SelectBySchool {

    String select_json;

    public SelectBySchool(String university){
        HttpURLConnection connection;
        try {
            //用GET方法向服务器传送数据，在链接里面传值
            String muniversity = URLEncoder.encode(university, "UTF-8");
            URL url = new URL("http://47.104.94.221:8080/JWebDemoByIDE/SchoolNewsServlet?university=" + muniversity);
