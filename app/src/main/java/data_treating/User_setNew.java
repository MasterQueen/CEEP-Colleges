...
public class User_setNew {
    ...
    public User_setNew(String university, String password){
        ...
        try {
            ...
            URL url = new URL("http://47.104.94.221:8080/JWebDemoByIDE/DeleteUserServlet?university=" + muniversity + "&password=" + mpassword);
