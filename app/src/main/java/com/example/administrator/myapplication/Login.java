...
import data_treating.LoginSchool;
...
public class Login extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            ...
            case R.id.login:
                ...
                university = school_name.getText().toString();
                password = et_password.getText().toString();
                new UserLoginTask(university, password).execute();
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                String is_login = new LoginSchool(muniversity, mpassword).getIs_login();
                System.out.println(is_login+muniversity+mpassword);
